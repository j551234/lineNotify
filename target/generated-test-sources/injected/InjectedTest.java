...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"io.jenkins.plugins:lineNotify:1.0-SNAPSHOT");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","C:\\Users\\USER\\Desktop\\lineNotify");
    parameters.put("artifactId","lineNotify");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","C:\\Users\\USER\\Desktop\\lineNotify\\target\\classes");
    parameters.put("testOutputDirectory","C:\\Users\\USER\\Desktop\\lineNotify\\target\\test-classes");
